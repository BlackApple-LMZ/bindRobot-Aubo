...
int main()
{
    ...
    while (cvGetWindowHandle(depth_win)&&cvGetWindowHandle(color_win)) // Application still alive?
    {
        ...
        string file1 = "/home/xcy/bindRobot/data/18070420039_7/R", file2 = "/home/xcy/bindRobot/data/18070420039_7/L", result1, result2, temp;
        m_sstream << i;
        m_sstream >> temp;
        result1 = file1 + temp + ".png";
        result2 = file2 + temp + ".png";
        m_sstream.clear();

        char c = cv::waitKey(30);
        switch (c) {
            case 's':
                imwrite(result1, color_image);
                i++;
            case 27:         //退出
                break;
            case 'p':         //暂停
